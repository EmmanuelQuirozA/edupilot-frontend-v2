    ...
    home: {
      ...
      paymentsPage: {
        ...
        requestsRecurrencesTable: {
          ...
          loading: 'Loading recurrences…',
          empty: 'No recurrences were found.',
          error: 'We could not load the payment request recurrences.',
          activeYes: 'Yes',
          activeNo: 'No',
        },
        table: {
        ...
        requestsRecurrencesFilters: {
          title: 'Recurrence filters',
          reset: 'Reset',
          closeAria: 'Close filters',
          fields: {
            reference: { label: 'Registration', placeholder: 'e.g. 1318' },
            student: { label: 'Student name', placeholder: 'e.g. ANDREA DANNAE' },
            gradeGroup: { label: 'Grade and group', placeholder: 'e.g. 6-A' },
            concept: { label: 'Concept', placeholder: 'e.g. Tuition' },
            paymentMonth: { label: 'Payment month' },
            active: { label: 'Active' },
          },
          activeOptions: {
            all: 'All',
