...
export const translations = {
  es: {
      ...
      studentsPage: {
        ...
        detail: {
          ...
          header: {
            ...
            roleFallback: 'Rol',
            groupStatusFallback: 'Estado de grupo',
            roleStatusFallback: 'Estado de rol',
          },
          summaryCard: {
            title: 'Cuenta del alumno',
            paymentReference: 'Referencia de pago',
            balanceLabel: 'Saldo actual',
            lastPayment: 'Último pago registrado',
            creditsLabel: 'Créditos de referencia',
            groupIdLabel: 'ID Grupo',
            balance: 'Añadir balance',
            registerPlaceholder: 'Ej. 5003',
            paymentReferencePlaceholder: 'Ingresa referencia',
          },
          institutionCard: {
            label: 'Institución',
            meta: 'Agrega o actualiza la información escolar.',
          ...
          contactCard: {
            ...
            subtitle: 'Datos personales y de contacto del alumno.',
            meta: 'Revisa los datos principales del alumno.',
            emptyValue: '—',
            summaryTitle: 'Datos principales',
            summary: {
              phone: 'Teléfono',
              birthDate: 'Fecha de nacimiento',
              taxId: 'RFC',
            ...
            addressHelper: 'Agrega la dirección actual del alumno.',
            fields: {
              firstName: 'Nombre',
              lastNameFather: 'Apellido paterno',
              lastNameMother: 'Apellido materno',
          ...
          validation: {
            ...
            invalidPersonalEmail: 'Correo inválido',
          },
          tables: {
            tuition: {
              loading: 'Cargando colegiaturas...',
    ...
    adminDashboard: {
      ...
      helper: 'Selecciona un bloque para abrir su configuración o monitorear métricas clave.',
      badge: 'Admin',
      actionsLabel: 'Áreas disponibles',
      logout: 'Cerrar sesión',
      keyMetricsTitle: 'Indicadores clave',
      keyMetricsHelper: 'Estado resumido de la operación y la red escolar.',
      keyMetricsLabel: 'Indicadores clave del panel',
      summaryCards: [
        { label: 'Escuelas activas', value: '24', helper: '+3 nuevas este mes', tag: 'Licencias' },
        { label: 'Usuarios totales', value: '4,280', helper: 'Docentes, padres y staff', tag: 'Usuarios' },
        { label: 'Cobros pendientes', value: '$58,200 MXN', helper: 'Revisar antes de viernes', tag: 'Finanzas' },
        { label: 'Pagos próximos', value: '$31,900 MXN', helper: 'Próximos 7 días', tag: 'Calendario' },
      ],
      billing: {
        monthLabel: 'Agosto 2024',
        nextCharge: '$42,500 MXN',
      },
      collectionsEyebrow: 'Cobros y facturación',
      collectionsTitle: 'Cobranza operativa',
      collectionsHelper: 'Revisa compromisos de pago y adeudos por vencer.',
      nextChargeLabel: 'Próxima facturación',
      upcomingPaymentsTitle: 'Pagos por venir',
      upcomingPaymentsHelper: 'Agenda semanal',
      upcomingPayments: [
        { school: 'Colegio Central', dueDate: '15 ago · Tarjeta', amount: '$12,400', status: 'Por confirmar' },
        { school: 'Instituto del Valle', dueDate: '17 ago · Transferencia', amount: '$9,800', status: 'Agendado' },
        { school: 'Liceo Horizonte', dueDate: '20 ago · SPEI', amount: '$9,700', status: 'Seguimiento' },
      ],
      pendingInvoicesTitle: 'Pagos pendientes',
      pendingInvoicesHelper: 'Requieren seguimiento',
      pendingInvoices: [
        { school: 'Colegio Andino', age: '15 días de atraso', amount: '$18,500', status: 'Vencido' },
        { school: 'Academia Sur', age: '7 días de atraso', amount: '$10,200', status: 'Recordatorio' },
      ],
      userMixEyebrow: 'Licencias y usuarios',
      userMixTitle: 'Distribución de cuentas',
      userMixHelper: 'Actividad semanal por tipo de rol.',
      userMix: [
        { label: 'Estudiantes activos', percentage: '68%', helper: '2,920 con acceso esta semana' },
        { label: 'Docentes activos', percentage: '21%', helper: '880 docentes ingresaron' },
        { label: 'Administradores', percentage: '11%', helper: '480 cuentas con permisos avanzados' },
      ],
      healthEyebrow: 'Salud operativa',
      healthTitle: 'Integridad del sistema',
      healthHelper: 'Estado de servicios críticos en producción.',
      systemHealth: [
        { label: 'Pagos y conciliaciones', helper: 'Conexión estable con proveedor PSP.', status: 'Operativo', statusVariant: 'success' },
        { label: 'Entrega de correos', helper: 'Retrasos puntuales en notificaciones masivas.', status: 'Atención', statusVariant: 'warning' },
        { label: 'Reportería', helper: 'Exportaciones encoladas con 3 min de retraso.', status: 'Monitor', statusVariant: 'warning' },
        { label: 'Autenticación', helper: 'Sin intentos sospechosos en la última hora.', status: 'Seguro', statusVariant: 'success' },
      ],
      actionsEyebrow: 'Atajos operativos',
      actionsTitle: 'Acciones rápidas',
      actionsHelper: 'Puntos de entrada frecuentes para la administración.',
      quickLinks: [
        {
  ...
  en: {
    ...
    home: {
      ...
      studentsPage: {
        ...
        detail: {
          ...
          header: {
            activeInGroup: 'Active in group',
            roleFallback: 'Role',
            groupStatusFallback: 'Group status',
            roleStatusFallback: 'Role status',
          },
          summaryCard: {
            title: 'Student account',
            paymentReference: 'Payment reference',
            balanceLabel: 'Current balance',
            lastPayment: 'Latest payment on record',
            creditsLabel: 'Reference credits',
            groupIdLabel: 'Group ID',
            balance: 'Add balance',
            registerPlaceholder: 'e.g. 5003',
            paymentReferencePlaceholder: 'Enter reference',
          },
          institutionCard: {
            label: 'Institution',
            meta: 'Add or update the school information.',
          ...
          contactCard: {
            ...
            subtitle: 'Personal and contact details for the student.',
            meta: 'Review the main details for the student.',
            emptyValue: '—',
            ...
            addressHelper: 'Add the current address for the student.',
            fields: {
              firstName: 'First name',
              lastNameFather: 'Paternal surname',
              lastNameMother: 'Maternal surname',
          ...
          validation: {
            ...
            invalidPersonalEmail: 'Invalid email',
          },
          tables: {
            tuition: {
              loading: 'Loading tuition information...',
          ...
          tuitionModal: {
            ...
            paymentsTable: {
              ...
              empty: 'There are no payments recorded for this month.',
              paymentLinkLabel: 'View detail',
            },
            requestButton: 'View payment request',
            close: 'Close',
          },
          balanceModal: {
            ...
            description: 'Enter the amount you want to add to the user balance.',
            studentInfoTitle: 'User information',
            nameLabel: 'Name',
            gradeLabel: 'Grade',
            groupLabel: 'Group',
            ...
            amountPlaceholder: '0.00',
            suggestionsLabel: 'Suggested amounts',
            cancel: 'Cancel',
            ...
            confirmText: 'Do you want to continue with the top-up?',
            confirmButton: 'Yes, top up',
            cancelButton: 'Cancel',
            genericError: 'We could not process the top-up.',
          },
        },
        bulkUploadPage: {
    ...
    adminDashboard: {
      ...
      helper: 'Pick a block to configure it or review the latest operational metrics.',
      badge: 'Admin',
      actionsLabel: 'Available areas',
      logout: 'Log out',
      keyMetricsTitle: 'Key indicators',
      keyMetricsHelper: 'Snapshot of the network and platform health.',
      keyMetricsLabel: 'Dashboard key indicators',
      summaryCards: [
        { label: 'Active schools', value: '24', helper: '+3 new this month', tag: 'Licenses' },
        { label: 'Total users', value: '4,280', helper: 'Teachers, guardians, staff', tag: 'Users' },
        { label: 'Pending collections', value: '$58,200 MXN', helper: 'Follow up before Friday', tag: 'Finance' },
        { label: 'Upcoming payments', value: '$31,900 MXN', helper: 'Next 7 days', tag: 'Schedule' },
      ],
      billing: {
        monthLabel: 'August 2024',
        nextCharge: '$42,500 MXN',
      },
      collectionsEyebrow: 'Collections & billing',
      collectionsTitle: 'Operational collections',
      collectionsHelper: 'Monitor committed payments and near-due invoices.',
      nextChargeLabel: 'Next billing',
      upcomingPaymentsTitle: 'Payments coming up',
      upcomingPaymentsHelper: 'Weekly agenda',
      upcomingPayments: [
        { school: 'Central School', dueDate: 'Aug 15 · Card', amount: '$12,400', status: 'To confirm' },
        { school: 'Valley Institute', dueDate: 'Aug 17 · Transfer', amount: '$9,800', status: 'Scheduled' },
        { school: 'Horizon Lyceum', dueDate: 'Aug 20 · ACH', amount: '$9,700', status: 'Follow-up' },
      ],
      pendingInvoicesTitle: 'Pending invoices',
      pendingInvoicesHelper: 'Need follow-up',
      pendingInvoices: [
        { school: 'Andean School', age: '15 days overdue', amount: '$18,500', status: 'Overdue' },
        { school: 'Southern Academy', age: '7 days overdue', amount: '$10,200', status: 'Reminder' },
      ],
      userMixEyebrow: 'Licenses & users',
      userMixTitle: 'Account distribution',
      userMixHelper: 'Weekly activity by role.',
      userMix: [
        { label: 'Active students', percentage: '68%', helper: '2,920 logged in this week' },
        { label: 'Active teachers', percentage: '21%', helper: '880 teachers logged in' },
        { label: 'Administrators', percentage: '11%', helper: '480 accounts with admin rights' },
      ],
      healthEyebrow: 'Operational health',
      healthTitle: 'System integrity',
      healthHelper: 'Status of critical production services.',
      systemHealth: [
        { label: 'Payments & reconciliation', helper: 'Stable connection with PSP provider.', status: 'Operational', statusVariant: 'success' },
        { label: 'Email delivery', helper: 'Minor delays on bulk notifications.', status: 'Attention', statusVariant: 'warning' },
        { label: 'Reporting', helper: 'Queued exports with 3 min delay.', status: 'Monitor', statusVariant: 'warning' },
        { label: 'Authentication', helper: 'No suspicious attempts in the last hour.', status: 'Secure', statusVariant: 'success' },
      ],
      actionsEyebrow: 'Operational shortcuts',
      actionsTitle: 'Quick actions',
      actionsHelper: 'Frequent entry points for administrators.',
      quickLinks: [
        {
